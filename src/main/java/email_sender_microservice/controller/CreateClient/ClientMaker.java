...
public class ClientMaker extends AbstractConnection{
    public static void main(String[] args) {
        try {
            ...
            Client newClient = new Client("PindurPandurok", "http://cartoonbros.com/powerpuff-girls/powerpuff-girls-6/", "http://cartoonbros.com/powerpuff-girls/powerpuff-girls-6/", "blue");
